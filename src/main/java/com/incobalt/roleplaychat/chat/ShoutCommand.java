...
/*
    ShoutCommand is the command class that registers /shout and /s.
    /shout sends a message to nearby players within a larger range than /say (3x larger)
    ...
    ShoutCommand extends CommandBase, which means it must implement a constructor and registerCommand()
...
public class ShoutCommand extends CommandBase {
    ...
    public ShoutCommand(ArrayList<String> a) {
    ...
    public void registerCommand(CommandDispatcher<CommandSource> dispatcher){
        ...
        CoreAPI.LOGGER.info("Registering Shout Command");
        ...
        for(String a : aliases) {
            ...
            //Commands.literal defines what the player types after the / (shout for /shout)
            ...
            LiteralArgumentBuilder<CommandSource> commandLiteral = Commands.literal(a)
                    .then(Commands.argument("message", MessageArgument.message())
                            .executes( ctx ->{
                                ...
                                ChatCommands.ProcessShout(message, source.getDisplayName().getFormattedText(), pos, source.getWorld());
